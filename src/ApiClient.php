...
interface ApiClient
{
     ...
     * @return array The JSON-decoded results array from Addressr.
     ...
     * 
     * This method should expect a GA ID (usually in the format of GA{STATE_?}{ID[0-9]}) and return the JSON-decoded 
     * address array from Addressr.
     * 
     * @param string $gwaId 
     * @return array The JSON-decoded address array from Addressr.
     ...
     * @throws \ManageItWA\PhpAddressr\Exception\ConnectionException If an error occurs while connecting to Addressr.
     * @throws \ManageItWA\PhpAddressr\Exception\NotFoundException If no address is found for the given GA ID.
     */
